// Generated from ./parser/Solidity.g4 by ANTLR 4.7
// jshint ignore: start
...
SolidityListener.prototype.enterNewExpression = function(ctx) {
};

// Exit a parse tree produced by SolidityParser#newExpression.
SolidityListener.prototype.exitNewExpression = function(ctx) {
};


// Enter a parse tree produced by SolidityParser#inlineAssemblyBlock.
SolidityListener.prototype.enterInlineAssemblyBlock = function(ctx) {
};

// Exit a parse tree produced by SolidityParser#inlineAssemblyBlock.
SolidityListener.prototype.exitInlineAssemblyBlock = function(ctx) {
};
...
// Enter a parse tree produced by SolidityParser#assemblyLocalBinding.
SolidityListener.prototype.enterAssemblyLocalBinding = function(ctx) {
};

// Exit a parse tree produced by SolidityParser#assemblyLocalBinding.
SolidityListener.prototype.exitAssemblyLocalBinding = function(ctx) {
};
...
// Enter a parse tree produced by SolidityParser#functionalAssemblyExpression.
SolidityListener.prototype.enterFunctionalAssemblyExpression = function(ctx) {
};

// Exit a parse tree produced by SolidityParser#functionalAssemblyExpression.
SolidityListener.prototype.exitFunctionalAssemblyExpression = function(ctx) {
};


// Enter a parse tree produced by SolidityParser#arrayLiteral.
SolidityListener.prototype.enterArrayLiteral = function(ctx) {
};

// Exit a parse tree produced by SolidityParser#arrayLiteral.
SolidityListener.prototype.exitArrayLiteral = function(ctx) {
};


// Enter a parse tree produced by SolidityParser#tupleLiteral.
SolidityListener.prototype.enterTupleLiteral = function(ctx) {
};

// Exit a parse tree produced by SolidityParser#tupleLiteral.
SolidityListener.prototype.exitTupleLiteral = function(ctx) {
};
